...
extern "C" {
    ...
    char* getdrivername PROTO((void));          //const char*
    ...
    int getch_graph PROTO((void));
    int kbhit_graph PROTO((void));
    void delay_graph PROTO((unsigned msec));
    void restorecrtmode PROTO((void));
    ...
    */
    ...
    int ismouseclick PROTO((UINT kind));
